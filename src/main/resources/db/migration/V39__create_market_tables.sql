...
CREATE INDEX IF NOT EXISTS idx_asset_isin ON assets(isin);
CREATE INDEX IF NOT EXISTS idx_asset_name ON assets(name);
CREATE INDEX IF NOT EXISTS idx_asset_tracked ON assets(is_tracked) WHERE is_tracked = TRUE;
CREATE INDEX IF NOT EXISTS idx_asset_featured ON assets(is_featured) WHERE is_featured = TRUE;

-- Quote History (time series data)
...
CREATE INDEX IF NOT EXISTS idx_quote_history_asset_date ON quote_history(asset_id, quote_date DESC);
...
CREATE INDEX IF NOT EXISTS idx_dividend_events_asset_date ON dividend_events(asset_id, event_date DESC);

-- Earnings Events (quarterly/annual results)
...
CREATE INDEX IF NOT EXISTS idx_earnings_events_asset_date ON earnings_events(asset_id, event_date DESC);
...
INSERT INTO asset_categories (code, name, description, display_order) VALUES
                                                                          ...
                                                                          ('COMMODITY', 'Commodities', 'Matérias-primas e commodities', 9),
